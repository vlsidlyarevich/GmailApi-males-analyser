package com.github.vlsidlyarevich.GMailQuickStart;
...
/*
    ...
    private static final String USER = "test51533@gmail.com";
    private static final String PASSWORD = "ytgjqvfyytdjh";
*/
    ...
    public static void main(String[] args) throws IOException, DecoderException {
        ...
        if (messages.size() == 0) {
            ...
            for (Message message : messages) {
               base64UrlDecode(getMessage(service, user, message.getId()));
            }
        }
    }
